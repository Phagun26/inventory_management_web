...
CREATE TABLE "new_User" (
    ...
    "mobileNumber" TEXT NOT NULL DEFAULT '0000000000',
    "isAdmin" BOOLEAN NOT NULL DEFAULT false,
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME NOT NULL
);
INSERT INTO "new_User" ("createdAt", "id", "isAdmin", "password", "updatedAt", "username") SELECT "createdAt", "id", "isAdmin", "password", "updatedAt", "username" FROM "User";
DROP TABLE "User";
